...
//detect user's speed and bluetooth communication
...
final class SerialViewController: UIViewController, UITextFieldDelegate, BluetoothSerialDelegate, CLLocationManagerDelegate {
